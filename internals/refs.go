/*
	We will create the Refs class to manage the HEAD, refs updates

	For now we will manage the HEAD file, we will request for a lock on the HEAD file to write our
	data on it then we will save our file
